#include <stdio.h>
#include <math.h>
//Testar se funciona quando os pontos são abaixo e acima de 0 (o requisitado) e quando não são
//Ver se valhe a pena fazer em c msm ou mudar para algo com html e interface gráfica.
